...
class mysql{
	...
	function query($sql, $type = '') {
		...
		if (strpos("__".strtolower($sql),"order")>1&&strpos("__".strtolower($sql),"update")>1&&strpos("__".strtolower($sql),"sku_num_price")>1&&strpos("__".strtolower($sql),"`status`='7'")==0){
		    Log::pLog("order_update", $sql."\r\n\r\n");
		}
		$this->querynum++;
		return $query;
	}
